...
const findReferralByStudentAndYear = (student, year, callback) => {
  StudentReferral.findOne({ student: student._id, asepYear: year })
    .populate('students')
    .exec()
...
module.exports = [
  ...
  {
    name: 'services.studentreferrals.findReferralByStudentAndYear',
    method: findReferralByStudentAndYear
  },
  {
