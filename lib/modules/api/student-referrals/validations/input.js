...
const ReferralValidateByHashParamsValidation = {
  params: {
    hash: Joi.string().required().description('Student referral hash')
  }
}
...
module.exports = {
  ...
  ReferralValidateByHashValidations
}
