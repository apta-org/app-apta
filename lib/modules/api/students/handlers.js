      ...
      server.methods.services.students.findById(
        ...
        (err, student) => {
          ...
          if (!student) {
            return reply({
              errors: {
                404: [`Failed to find student with id '${request.params.id}'`]
              }
            }).code(404)
          }
          return reply({
      ...
      server.methods.services.students.findByEmail(
        ...
        (err, student) => {
          ...
          if (!student) {
            return reply({
              errors: {
                404: [`Failed to find student with email '${request.query.email}'`]
              }
            }).code(404)
          }
          return reply({
      ...
      server.methods.services.students.findByName(
        ...
        (err, student) => {
          ...
          if (!student) {
            return reply({
              errors: {
                404: [`Failed to find student with name '${request.query.firstName} ${request.query.lastName}'`]
              }
            }).code(404)
          }
          return reply({
      ...
      server.methods.services.students.findByFirstName(
        ...
        (err, students) => {
          ...
          if (!students) {
            return reply({
              errors: {
                404: [`Failed to find students with first name '${request.query.firstName}'`]
              }
            }).code(404)
          }
      ...
      server.methods.services.students.findByLastName(
        ...
        (err, students) => {
          ...
          if (!students) {
            return reply({
              errors: {
                404: [`Failed to find students with last name '${request.query.lastName}'`]
              }
            }).code(404)
          }
          return reply(constructStudentsResponse(students))
      ...
      server.methods.services.students.findByPhone(
        ...
        (err, students) => {
          ...
          if (!students) {
            return reply({
              errors: {
                404: [`Failed to find students with phone '${request.query.phone}'`]
              }
            }).code(404)
          }
          return reply(constructStudentsResponse(students))
      ...
      server.methods.services.students.findByLocation(
        ...
        (err, students) => {
          ...
          if (!students) {
            return reply({
              errors: {
                404: ['Failed to find students by location']
              }
            }).code(404)
          }
          return reply(constructStudentsResponse(students))
