...
module.exports = (server) => {
  ...
  return [
    ...
    // GET /api/students/by-first-name?firstName={firstName}
    {
      ...
      config: {
        description: 'Get matching students by first name',
    ...
    // GET /api/students/by-last-name?lastName={lastName}
    {
      ...
      config: {
        description: 'Get matching students by last name',
        notes: 'Return matching students',
        tags: ['api', 'students'],
    ...
    // GET /api/students/by-phone?phone={phone}
    {
      ...
      config: {
        description: 'Get matching students by phone number',
        notes: 'Return matching students',
        tags: ['api', 'students'],
    ...
    // GET /api/students/by-location?city={cityName}&district={districtName}&&state={stateCode}
    {
      ...
      config: {
        description: 'Get matching students by location',
        notes: 'Return matching students',
        tags: ['api', 'students'],
