...
const StudentByEmailQueryValidations = {
  query: {
    email: Joi.string().regex(regExEmail).description('Find student by email')
  },
...
const StudentByNameQueryValidations = {
  query: Joi.object().keys({
    firstName: Joi.string().description('Find student by name'),
    lastName: Joi.string().description('Find student by name')
...
const StudentsByFirstNameQueryValidations = {
  query: {
    firstName: Joi.string().description('Find students matching by firstName')
  },
  failAction: validateOptions.failAction
}
...
const StudentsByLastNameQueryValidations = {
  query: {
    lastName: Joi.string().description('Find students matching by lastName')
  },
  failAction: validateOptions.failAction
}
...
const StudentsByPhoneNumberQueryValidations = {
  query: {
    phone: Joi.string().regex(regExPhone).description('Find students matching by phone number')
  },
  failAction: validateOptions.failAction
}
